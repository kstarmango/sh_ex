...
import egovframework.syesd.cmmn.util.service.EgovFormBasedUUID;
/**
...
public class EgovResourceCloseHelper {
	...
	private static Logger logger = LogManager.getLogger(EgovResourceCloseHelper.class);
		...
		for (Object object : objects) {
			if (object != null) {
				if (object instanceof ResultSet) {
					...
					logger.error("closeDBObjects Error");
