package egovframework.syesd.cmmn.util.service;
...
public class EgovFileUploadUtil extends EgovFormBasedFileUtil {
	 ...
	 * @throws Exception
	 */
	public static List<EgovFormBasedFileVo> uploadFiles(HttpServletRequest request, String where, long maxFileSize) throws IOException {
		List<EgovFormBasedFileVo> list = new ArrayList<EgovFormBasedFileVo>();

		MultipartHttpServletRequest mptRequest = (MultipartHttpServletRequest) request;
		//기존MultipartHttpServletRequest mptRequest = WebUtils.getNativeRequest(request,MultipartHttpServletRequest.class);
	 ...
	 * @throws Exception
	 */
	public static List<EgovFormBasedFileVo> uploadFilesExt(MultipartHttpServletRequest mptRequest, String where, long maxFileSize, String extensionWhiteList) throws IOException {
		List<EgovFormBasedFileVo> list = new ArrayList<EgovFormBasedFileVo>();
