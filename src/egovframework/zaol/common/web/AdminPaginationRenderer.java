...
public class AdminPaginationRenderer extends AbstractPaginationRenderer {
    ...
    */
	public AdminPaginationRenderer() {
		...
		String strWebDir = "/images/ad/";
		
		firstPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\"><img src=\"/images/ad/first_page_ico.png\" border=\"0\"/></a>&#160;"; 
        previousPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" +
        						"<img src=\"/images/ad/before_page_ico.png\" border=\"0\"/></a>&#160;";
        currentPageLabel = "<strong class=\"font_bold_blue\">{0}</strong>&#160;";
        otherPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\" class=\"shortcut_link\">{2}</a>&#160;";
        nextPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" +
        					"<img src=\"/images/ad/next_page_ico.png\" border=\"0\"/></a>&#160;";
        lastPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" +
        					"<img src=\"/images/ad/end_page_ico.png\" border=\"0\"/></a>&#160;";
	}
}
