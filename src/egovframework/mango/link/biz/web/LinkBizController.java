package egovframework.mango.link.biz.web;
...
import egovframework.mango.link.biz.service.LinkBizService;
...
@Controller
public class LinkBizController extends BaseController {

	private static Logger logger = LogManager.getLogger(LinkBizController.class);

	private ObjectMapper mapper;

	@Autowired
	private LinkBizService linkBizService;
	...
	@RequestMapping(value=RequestMappingConstants.WEB_LINK_BIZ,
			method = {RequestMethod.GET, RequestMethod.POST})
	 public String linkBiz (HttpServletRequest request, HttpServletResponse response,
...
//  @RequestMapping(value = "/biz/get",
//		  method = {RequestMethod.GET})
//  public void getBizUrl(HttpServletRequest request, HttpServletResponse response) throws Exception {
//
//      String baseUrl = request.getContextPath()+"/shex/biz/";
//      String baseUrl = "https://shgis.syesd.co.kr/shex/biz/";
...
//      return new ModelAndView("redirect:" + "redirect:"+resUrl);
