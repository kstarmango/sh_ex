package egovframework.mango.link.bld.web;
...
import egovframework.mango.link.bld.service.LinkBldService;
...
@Controller
public class LinkBldController extends BaseController {

	private static Logger logger = LogManager.getLogger(LinkBldController.class);

	private ObjectMapper mapper;

	@Autowired
	private LinkBldService linkBldService;
	...
	@RequestMapping(value="/link/bld.do",
			method = {RequestMethod.GET, RequestMethod.POST})
	 public String linkBld (HttpServletRequest request, HttpServletResponse response,
...
//        	model.addAttribute("geoserverURL", "http://128.134.95.129:8080/geoserver/SH_LM/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20");
	...
	@RequestMapping(value = "/bld/get",
			  method = {RequestMethod.GET})
	  public String getBizUrl(HttpServletRequest request) throws NullPointerException, Exception {

//		String baseUrl = request.getContextPath()+"/shex/bld/";
		String baseUrl = "https://shgis.syesd.co.kr/shex/bld/";
