package egovframework.mango.link.bld.service;
...
import egovframework.mango.link.bld.service.impl.LinkBldDAO;
...
@Service
public class LinkBldService {
	
	private static Logger logger = LogManager.getLogger(LinkBldService.class);
