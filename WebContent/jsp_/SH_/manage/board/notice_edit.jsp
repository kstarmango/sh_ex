...
<!--     <script src="/jsp/SH/js/jquery.validate.min.js"></script> -->
	...
	function edit_notice(){
		$("form").attr("action", "/noticeUpdateStart.do");
		$("form").attr("method", "post");
		$("form").submit();
	}
...
<body>	
	...
	<div class="wrapper">
	    <div class="container">
			...
			<input type="hidden" name="seq" value="<c:out value="${noticeList[0].seq}" />"/>
	        <div class="row">
	            <div class="col-sm-12">
	                    ...
	                    <div class="table-wrap col-sm-10 col-sm-offset-1 m-t-30 m-b-40">
	                        ...
	                        <table class="table table-custom">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                        <input class="form-control required" name="board_sjt" id="board_sjt"  type="text" maxlength="20" title="제목" placeholder="제목을 입력해주세요." value='<c:out value="${noticeList[0].board_sjt}"/>'/>                                            
                                        </td>
                                    </tr>                                       
                                    <tr>
                                        <th scope="row">공개여부<span class="text-danger">*</span></th>
                                        <td colspan="3">
                                           <input type="radio" name="use_at" value="Y" <c:if test="${noticeList[0].use_at eq 'Y' }">checked="checked"</c:if> /> 공개
							               <input type="radio" name="use_at"  value="N" <c:if test="${noticeList[0].use_at eq 'N' }">checked="checked"</c:if> /> 비공개
						            	</td>
<!-- 						            	<th > -->
...
<!-- 		                                </td> -->
                                    ...
                                    <tr>
		                                ...
		                                <td>
		                                    <div class="input-group date datetimepickerStart m-b-5">
                                                	<input class="form-control input-group-addon m-b-0" name="open_start_date"  id="open_start_date" title ="알림  시작일"  placeholder="알림  시작일 선택하세요" value='<c:out value="${noticeList[0].open_start_date}"/>'/>
		                                ...
		                                <td>
		                                    <div class="input-group date datetimepickerEnd m-b-5">
                                                	<input class="form-control input-group-addon m-b-0" name="close_end_date" id="close_end_date" title ="알림  종료일 "  placeholder="알림  종료일 선택하세요" value='<c:out value="${noticeList[0].close_end_date}"/>'/>
                                                    <span class="input-group-addon bg-info b-0"><i class="fa fa-calendar text-white"></i></span>
                                            </div>
                                    ...
                                    <th scope="row">내용<span class="text-danger">*</span></th>
                                     <td colspan="3">                 
                                             <textarea name="board_contents" id="board_contents" rows="20"  class="form-control" placeholder="내용을 입력해주세요." title="내용" ><c:out value="${noticeList[0].board_contents}"/></textarea>
                                     </td>
                                   	</tr>
                                    </tbody>
                                </table>
