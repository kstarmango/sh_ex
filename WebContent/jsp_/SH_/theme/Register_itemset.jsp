	            ...
	            <div class="col-sm-12">
	                <div class="card-box big-card-box last table-responsive searchResult">
	                                ...
	                                <div class="card-box">
	                                    ...
	                                    <div class="card-box-inner cb-inner03">
	                                        <div class="form-group">
	                                            ...
	                                            <input type="text" class="form-control input-sm" placeholder="주제를 입력해주세요." name="subject">
	                                        </div>
	                                        <div class="form-group">
	                                            <label for="">부 제목</label>
	                                            <input type="text" class="form-control input-sm" placeholder="제목을 입력해주세요." name="title">
	                                        </div>
	                                        <div class="form-group">
	                                            <label for="">추가 항목 1</label>
	                                            <input type="text" class="form-control input-sm" placeholder="항목을 입력해주세요." name="sub1">
	                                        </div>
	                                        <div class="form-group">
	                                            <label for="">추가 항목 2</label>
	                                            <input type="text" class="form-control input-sm" placeholder="항목을 입력해주세요." name="sub2">
	                                        </div>
	                                        <div class="form-group">
	                                        	<th scope="row">공개여부<span class="text-danger">*</span></th>
	                                        	<td colspan="3">
	                                           <input type="radio" name="use_at" value="Y" /> 공개
								               <input type="radio" name="use_at"  value="N" checked="checked"/> 비공개
							            	</td>
	                                        </div>
	                                    </div>
	                                </div>
	                    ...
	                    <div class="modal-footer">
	                        ...
	                        <button type="button" class="btn btn-custom btn-md" onclick="register_prev();">
