...
/*     			console.log('총괄표제부: ' + JSON.stringify(buld_list_1));
    			console.log('총괄표제부 length: ' + buld_list_1.length);
    			console.log('전유부 :' + JSON.stringify(buld_list_2));
    			console.log('전유부 : length' + buld_list_2.length);
    			console.log('표제부 : ' + JSON.stringify(buld_list_3));
    			console.log('표제부 : length ' + buld_list_3.length);
 */    			
                                        ...
                                        <div id="dv-land" class="tab-pane fade in active">
                                        	<div class="table-wrap">
                                                ...
                                                <table class="table table-custom table-cen table-num text-center" width="100%">
                                                    ...
                                                    <%-- <b>데이터기준일자 : </b>
                                                    <c:choose>
                                                    	<c:when test="${!empty land_list_1[0].stdmt}"><span id="detail_land_stdmt"><c:out value="2020"/></span></c:when>
...
<!-- 									                      <button type="button" class="btn btn-sm btn-md w-xs btnHist">이력조회</button>     -->
	                                        		...
	                                        		<c:if test="${sh_kind eq 'data_guk_land'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_guk_land.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_tmseq_land'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_tmseq_land.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_region_land'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_region_land.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_owned_city'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_owned_city.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_owned_guyu'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_owned_guyu.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_residual_land'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_residual_land.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_unsold_land'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_unsold_land.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_invest'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_invest.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_public_site'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_public_site.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_public_parking'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_public_parking.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_generations'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_generations.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_council_land'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_council_land.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_minuse'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_minuse.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_industry'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_industry.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_priority'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_priority.jsp"></c:import>
	                                        		</c:if>
	                                        		...
	                                        		<c:if test="${sh_kind eq 'data_cynlst'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_cynlst.jsp"></c:import>
	                                        		</c:if>
<%-- 	                                        		<c:if test="${sh_kind eq 'data_public_buld_a'}"> --%>
<%-- 	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_public_buld_a.jsp"></c:import> --%>
<%-- 	                                        		</c:if> --%>
<%-- 	                                        		<c:if test="${sh_kind eq 'data_public_buld_b'}"> --%>
<%-- 	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_public_buld_b.jsp"></c:import> --%>
<%-- 	                                        		</c:if> --%>
	                                        		<c:if test="${sh_kind eq 'data_public_buld_c'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_public_buld_c.jsp"></c:import>
	                                        		</c:if>
                                        		<c:if test="${sh_kind eq 'data_public_asbu'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_public_asbu.jsp"></c:import>
	                                        		</c:if> 
													<c:if test="${sh_kind eq 'data_purchase'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_purchase.jsp"></c:import>
	                                        		</c:if>
	                                        		<c:if test="${sh_kind eq 'data_declining'}">
	                                        			<c:import url="/jsp/SH_/landhist/detail/Detail_declining.jsp"></c:import>
	                                        		</c:if>
