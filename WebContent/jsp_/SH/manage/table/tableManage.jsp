        ...
        function fn_table_reload() {
  			$.ajax({
  				...
  				success : function(data) {
					...
					$("span[name*='tableListCount']").text(data.tableInfo.length);
...
<body>
	...
	<div class="wrapper">
	    <div class="container">
	        ...
	        <div class="row" id="tableEdit" style='display: block;'>
	        	<div class="col-sm-12">
	                    ...
	                    <div class="sysstat-wrap m-t-30 m-b-30">
	                        ...
	                        <form id="tableListForm" name="tableListForm" class="form-horizontal">
							    ...
							    <div class="row">
		                           	<div class="col-md-10">
		                            	<div class="form-group">
		                                     <label for="s_serch_table_space" class="col-md-1 control-label">테이블영역</label>
		                                     <div class="col-md-3">
		                                         <select class="form-control" id="s_serch_table_space" name="s_serch_table_space" title ="테이블스페이스">
		                                         	<option value="">전체</option>
		                                         </select>
		                                     </div>
		                                     <label for="s_serch_table_gis_yn" class="col-md-1 control-label">GIS 여부</label>
		                                     <div class="col-md-3">
	                        ...
	                        <div class="row">
	                            <div class="col-sm-4">
	                                <div class="card-box">
					                    <h5 class="header-title"><b>테이블 목록</b> <span class="small">(전체 <b class="text-orange"><span name='tableListCount'>0</span></b>건)</span></h5>

                           				<div class="table-wrap m-t-30" style='height: 670px; overflow-y:auto' id='tableTreeView'></div>
	                            ...
	                            <div class="col-sm-8">
	                                <div class="card-box">
					                    ...
					                    <div class="table-wrap m-t-30" style='height:352px;  overflow-y:auto'>
					                        <table class="table table-custom table-cen table-num text-center table-hover" width="100%" id='columnEditRow'>
					                            <colgroup>
					                            	<col width="5%">
					                                <col width="25%">
					                                <col width="40%">
