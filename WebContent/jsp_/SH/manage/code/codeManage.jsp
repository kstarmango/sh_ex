...
<body>
	...
	<div class="wrapper">
	    <div class="container">
	        ...
	        <div class="row" id="codeEdit" style='display: block;'>
	        	<div class="col-sm-12">
	                            ...
	                            <div class="col-sm-4">
	                                <div class="card-box">
					                    <h5 class="header-title"><b>코드 목록</b> <span class="small">(전체 <b class="text-orange"><c:out value="${view01Cnt.totalRecordCount}"/></b>건)</span></h5>
                           				...
                           				<div class="table-wrap m-t-30" style='height: 740px; overflow-y:auto' id='codeTreeView'></div>
					                        ...
					                        <table class="table table-custom table-cen table-num text-center table-hover" width="100%">
					                            ...
					                            <tbody>
				                                	<tr>
				                                       ...
				                                       <td>
				                                       	<select name="p_code" id="p_code" class="form-control col-md-3 input-sm">
													    </select>
				                                      <!--  <input class="form-control required" name="p_code" id="p_code"  type="text" maxlength="20" title="상위 그룹 NO." placeholder="" /> -->
				                                       ...
				                                       <td>
				                                       		<select name="code_order" id="code_order" class="form-control col-md-3 input-sm">
													    	</select>
