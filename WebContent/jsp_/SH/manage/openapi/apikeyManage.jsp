...
<head>
	...
	function fn_link_list(pageNo) {
		$("#apikeyListForm").append('<input type="hidden" name="pageIndex" id="pageIndex" value="' + pageNo + '"/>');
		$("#apikeyListForm").append('<input type="hidden" name="pageSort"  id="pageSort"  value="${pageSort}" />');
		$("#apikeyListForm").append('<input type="hidden" name="pageOrder" id="pageOrder" value="${pageOrder}" />');
		$("#apikeyListForm").attr("method", "post");
		$("#apikeyListForm").attr("action", "<%=RequestMappingConstants.WEB_MNG_APIKEY%>");
	                ...
	                <div class="page-title-box">
	                    <div class="btn-group pull-right">
	                        <ol class="breadcrumb hide-phone p-0 m-0">
	                            ...
	                            <li>
	                                <a href="<%=RequestMappingConstants.WEB_MNG_APIKEY%>">${sesMenuNavigation.p_progrm_nm}</a>
	                            </li>
	                            <li class="active">
	                        ...
	                        <table class="table table-custom table-cen table-num text-center table-hover" width="100%">
	                            ...
	                            <tbody>
									...
									<tr>
									  	...
									  	<td colspan="3">
									  		<textarea name="sys_desc" id='sys_desc' cols="100" rows="3" style="resize: none;" disabled></textarea>
									 	</td>
									</tr>
									<tr>
									  	<th scope="row">사용목적</th>
									  	<td colspan="3" >
									  		<textarea name="use_purps" id='use_purps' cols="100" rows="3" style="resize: none;" disabled></textarea>
									 	</td>
									</tr>					
									<tr>
	                        ...
	                        <table class="table table-custom table-cen table-num text-center table-hover" width="100%">
	                            ...
	                            <tbody>
		                            ...
		                            <tr>
		                                <th scope="row">프로그램 권한</th>	
		                                <td>
											<select name="new_p_auth_no" id="new_p_auth_no" class="form-control col-md-3 input-sm">
												<option value=""></option>
												<c:forEach var="item1" items="${progrmAuthList}">
		                                ...
		                                <th scope="row">지도레이어 권한</th>	
		                                <td>
											<select name="new_l_auth_no" id="new_l_auth_no" class="form-control col-md-3 input-sm">
												<option value=""></option>
												<c:forEach var="item2" items="${layerAuthList}">
