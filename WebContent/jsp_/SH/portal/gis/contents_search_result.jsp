		...
		<script type="text/javascript">
		    ...
		    function fn_search_data_item_click(e) {
		    	...
		    	//231129기존소스 주석처리-----
		    	//if(table_nm == "TB_APT" || table_nm == "TB_MLTDWL" || table_nm == "TB_CTY_LVLH" || table_nm == "TB_LFSTS_RENT" || table_nm == "TB_LNGTR_SAFETY" || table_nm == "TB_ASSETS_MLTDWL"|| table_nm == "TB_ASSETS_ETC"|| table_nm == "TB_REMNDR_PAPR"){
		    	
		    	if(table_nm == "TB_APT" || table_nm == "TB_MLTDWL" || table_nm == "TB_CTY_LVLH" || table_nm == "TB_ASSETS_APT"|| table_nm == "TB_ASSETS_MLTDWL"|| table_nm == "TB_ASSETS_ETC"){
			    ...
			            type: "POST",
			    		async : true,
			            url: "<%=RequestMappingConstants.WEB_GIS_DATA_GEOMETRY%>",
			            data : {
