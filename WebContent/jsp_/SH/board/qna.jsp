	...
	<div class="wrapper">
	    <div class="container">
	                               ...
	                               <c:choose>
										<c:when test="${!empty boardList}">
											<c:forEach items="${boardList}" var="result" varStatus="status">
												...
												<input type="hidden" class="articleNoClass" id="articleNo" name="articleNo${result.article_no}" value="${result.article_no}"/>
	        ...
	        <div class="row" id='boardDetail' style='position: absolute; width: 900px; display: none; z-index:100; ' role="dialog">
	            <div class="col-sm-12" id='boardBox' name='boardBox'>
	                <div class="card-box big-card-box last table-responsive searchResult">
	                    ...
	                    <div class="table-wrap m-t-30" id="tbQnaDiv">
	                        <table class="table table-custom table-cen table-num text-center table-hover" width="100%">
	                            ...
	                            <tbody>
		                            ...
		                            <tr>
		                                <th scope="row">내용</th>
		                                <td colspan="3" class="td-expand" name="article_conts" id="article_conts" style="text-align: left;">
