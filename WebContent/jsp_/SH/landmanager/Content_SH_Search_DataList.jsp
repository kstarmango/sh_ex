		                        ...
		                        <div class="col-xs-12">
		                            <div id="land-datalist">
		                                <div class="list-group">  
		                                       		...
		                                       		<div class="row ch-box">
			                                       		<div class="col-xs-12">
			                                       			...
			                                       			<div class="row collapse in" id="fs_guk_land_list">
				                                       			...
				                                       			<div class="col-xs-6"><input type="checkbox" id="fs_guk_land_03"/>&nbsp;<label for="fs_guk_land_03">매각제한대상</label></div>
											...
											<div class="form-group row">
		                                       	<div class="col-xs-12">
		                                       		...
		                                       		<div class="row ch-box">
			                                       		<div class="col-xs-12">
			                                       			<div class="row">
			                                       				<input type="checkbox" id="fs_residual_land_00"/>&nbsp;<label for="fs_residual_land_00">SH잔여지(**작업중)</label>
			                                       			</div>	
				                                       		
				                                       		<div class="row">
			                                       				<input type="checkbox" id="fs_unsold_land_00"/>&nbsp;<label for="fs_unsold_land_00">SH미매각지(**작업중)</label>
			                                       			</div>
			                                       			
			                                       			<div class="row">
			                                       				<input type="checkbox" id="fs_invest_00"/>&nbsp;<label for="fs_invest_00">현물출자(**작업중)</label>
			                                       			</div>			                                       			
			                                       		</div>
		                                       		</div>
												</div>                                           
		                                	...
		                                	<div class="form-group row">
		                                       	<div class="col-xs-12">
		                                       		<label><i class="fa fa-caret-square-o-right m-r-5"></i>공공기관이전부지 (데이터 준비중)</label>
		                                       		<div class="row ch-box">
			                                       		<div class="col-xs-12">
			                                       			<div class="row">
		                                       		...
		                                       		<div class="row ch-box">
			                                       		<div class="col-xs-12">
			                                       			...
			                                       			<div class="row collapse in" id="fn_guk_buld_list">
				                                       			...
				                                       			<div class="col-xs-6"><input type="checkbox" id="fn_guk_buld_03"/>&nbsp;<label for="fn_guk_buld_03">매각제한대상</label></div>
											...
											<div class="form-group row">
		                                       	<div class="col-xs-12">
		                                       		...
		                                       		<div class="row ch-box">
			                                       		<div class="col-xs-12">
			                                       			<div class="row">
			                                       				<input type="checkbox" id="fn_public_buld_a_00"/>&nbsp;<label for="fn_public_buld_a_00">국공립(**작업중)</label>
			                                       			</div>	
			                                       			
			                                       			<div class="row">
			                                       				<input type="checkbox" id="fn_public_buld_b_00"/>&nbsp;<label for="fn_public_buld_b_00">서울시(**작업중)</label>
			                                       			</div>	
		                                	...
		                                	<div class="form-group row">
		                                       	<div class="col-xs-12">
		                                       		...
		                                       		<div class="row ch-box">
			                                       		<div class="col-xs-12">
			                                       			<div class="row">
			                                       				<input type="checkbox" id="fn_public_asbu_00"/>&nbsp;<label for="fn_public_asbu_00">공공기관이전건물(**작업중)</label>
			                                       			</div>			                                       		
			                                       		</div>
		                                       		</div>
												</div>                                           
