			...
			<div class="sp-content-wrap">
	            ...
	            <!--정보 Panel-Content -->
		            <div class="sp-content-inner p-20" id="layer-tab">
	                   	...
	                   	<div class="sp-box m-b-20" id='info_mini_land'>
	                    ...
	                    <div class="sp-box m-b-20" id='info_mini_build'>
	                    ...
	                    <div class="sp-box m-b-20" id='info_mini_empty'>
	                    	<h4 class="header-title m-t-0" style="color: #3C55A5;">빈집정보</h4>
	                   		<table class="table table-custom table-cen table-num text-center" width="100%">
	                            <colgroup>
	                                <col width="20%"/> <col width="30%"/> <col width="20%"/> <col width="30%"/>
	                            </colgroup>
	                            <tbody>
	                            	<tr>
	                            		<th scope="row">상태</th><td id="info_mini_a90"></td>
	                            		<th scope="row">정책위원회</th><td id="info_mini_a91"></td>
	                             	</tr>
	                             	<tr>
	                            		<th scope="row">잔금일</th><td id="info_mini_a92"></td>
	                            		<th scope="row">매도희망일</th><td id="info_mini_a93"></td>
	                             	</tr>
	                             	<tr>
	                            		<th scope="row">감정금액</th><td id="info_mini_a94"></td>
	                            		<th scope="row">매입금액</th><td id="info_mini_a95"></td>
	                             	</tr>
	                            </tbody>
	                        </table>
	             		</div> 					  
