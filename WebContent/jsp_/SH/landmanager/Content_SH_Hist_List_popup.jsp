		                                    ...
		                                    <div class="tab-content detail-view">
		                                        <div class="table-wrap" id="table_dist_one">
	                                        		<table class="table table-custom table-cen table-num text-center" width="100%" height="100%" id="table_sh">
	                                                    ...
	                                                    <tbody>
	                                                    <tr>
	                                                    <c:forEach var="result" items="${sh_hist_comment}" varStatus="status">
	                                                        <th><c:out value="${result.column_comment}"/></th>
	                                                    </c:forEach>
	                                                    </tr>
	                                                    <c:forEach var="hidata" items="${histShData}" varStatus="status">
	                                                      <tr>
	                                                        <td></td>
	                                                      </tr>  
	                                                    </c:forEach>
