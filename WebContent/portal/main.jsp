...
<body onload="checkDup();">
		...
		<tr>
				...
				<div>
					<ul class="menu">
						<li class="menu-item">
							...
							<ul class="sub-menu">
								<li id="menu-conn1"><img class="menu-icon" src="./images/icon_submenu.png"/>TEST-SP2</li>
							</ul>
						</li>
				    </ul>
				</div>
			...
			<td id="main">
				<table id="header-table">
					<tr id="header">
						<td id="logo">
							Test Login Site - <%=XSSCheck(spname)%>
						</td>
						<td id="photo">
						...
						<td id="logout">
							<img id="logout_img" alt="" src="./images/logout_n.png"/>
						</td>
					</tr>
					<tr id="header-bottom">
						<td colspan="5"></td>
	...
	$("#menu-conn1").click(function() {
		if (MagicSSO.isLogon()) {
			window.open("http://sp2.dev.com:40007/sso/RequestConnect.jsp?RelayState=/portal/connectMain.jsp", "_self");
		}
		else {
			location.href = "<%=XSSCheck(DEFAULT_BASE_URL)%>";
		}
