    ...
    <div class="con_wrap">
        <div class="contents_box02">
	        ...
	        <form name="pwdForm" id="pwdForm" method="post">
                        ...
                        <button class="blue_btn02 width_80p" ><a href="#a" data-modal-id="popup3" id="npwSubmit" onclick="newPwdChangeStart();">확인</a></button>                     
                    </div>
                   </div>
                  </div>
                  </div>
...
<script>
	...
	function newPwdChangeStart()
	{
		var frm = document.getElementById("pwdForm");
