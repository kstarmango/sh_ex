...
(function (factory) {
  ...
  var codable = renderer.create('<textarea class="note-codable" title="내용"/>');
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-form-group note-group-select-from-files">' +
                   ...
                   ' type="file" name="files" accept="image/*" multiple="multiple" title="파일" />' +
                   imageLimitation +
                 '</div>' + 
                 '<div class="form-group note-group-image-url" style="overflow:auto;">' +
                   '<label class="note-form-label">' + lang.image.url + '</label>' +
                   '<input class="note-image-url form-control note-form-control note-input ' +
                   ' col-md-12" type="text" title="사진 URL"/>' +
                 '</div>';
      var footer = '<button href="#" class="btn btn-primary note-btn note-btn-primary ' +
