                ...
                return function (queIdx) {
                    ...
                    if (!item.$display) {
                        ...
                        if (item.$target.find("select").get(0)) {
                            ...
                            // select 속성만 변경
                            item.$select.attr("tabindex", "-1").attr("class", "form-control " + data.formSize).attr("title", "선택");
                            if (data.name) {
                ...
                var getSelected = function getSelected(_item, o, selected) {
                    ...
                    'index': function index(queIdx, value, selected) {
                        ...
                        if (U.isString(value.index.gindex)) {
                            ...
                            if(item.options.length>0&&item.options.length > value.index.index){
