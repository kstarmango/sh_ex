...
<%@ page import="egovframework.syesd.cmmn.constants.RequestMappingConstants"%>
	...
	<div class="contWrap">
        ...
        <div class="whiteCont">
            ...
            <!-- Detail Page-Body -->
	        <div class="row hei_100" id="progrmEdit">
	                            ...
	                            <div class="col-sm-4">
	                                <div class="card-box">
					                    <h5 class="header-title"><b>메뉴 목록</b> <span class="small">(전체 <b class="text-orange"><c:out value="${view01Cnt.totalRecordCount}"/></b>건)</span></h5>
                           				...
                           				<div class="table-wrap m-t-30" style='height: 708px; overflow-y:scroll' id='progrmTreeview'></div>
	                                ...
	                                <div class="card-box">
					                    ...
					                    <div class="table-wrap m-t-30">
					                        <table class="table table-custom table-cen table-num text-center table-hover" >
					                        	<caption class="none">메뉴 상세 테이블</caption>
					                            <colgroup>
					                            	<col style="width:20%">
				                        			<col style="width:30%">
				                        			<col style="width:20%">
					                            ...
					                            <tbody>
				                                	<tr>
				                                       ...
				                                       <td colspan="1">
															<select name="p_progrm_no" id="p_progrm_no" class="form-control col-md-3 input-sm" title="상위메뉴">
				                                       ...
				                                       <td colspan="1">
															<select name="re_p_progrm_no" id="re_p_progrm_no" class="form-control col-md-3 input-sm" title="변경 상위 메뉴">
																<option value=''>최 상위 메뉴</option>
															<c:choose>
															<c:when test="${!empty progrmList}">
																<c:forEach items="${progrmList}" var="result" varStatus="status">
				                                	...
				                                	<tr>
				                                       	...
				                                       	<td>
				                                       		<select name="re_progrm_order" id="re_progrm_order" class="form-control col-md-3 input-sm" style='width: 50px' title="변경 표출 순서">
				                                       		</select>
				                                       		다음으로 순서 변경
				                                       	</td>
				                                    </tr>
	        ...
	        <div class="row"  id="progrmAdd" style='position: absolute; display: none; z-index:100'>
	        	<div class="col-sm-10">
	            	<div class="card-box big-card-box last table-responsive searchResult">
		                    ...
		                    <div class="table-wrap m-t-30">
		                        <table class="table table-custom table-cen table-num text-center table-hover" >
		                        	<caption class="none">메뉴 신규 등록 테이블</caption>
		                            <colgroup>
		                            	<col style="width:20%">
                        				<col style="width:30%">
                        				<col style="width:20%">
		                            ...
		                            <tbody>
	                                	<tr>
	                                       ...
	                                       <td colspan="3">
												<select name="new_p_progrm_no" id="new_p_progrm_no" class="form-control col-md-3 input-sm" title="상위 메뉴명">
													<option value=''>최 상위 메뉴</option>
												<c:choose>
												<c:when test="${!empty progrmList}">
													<c:forEach items="${progrmList}" var="result" varStatus="status">
