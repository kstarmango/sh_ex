...
<%@ page import="egovframework.syesd.cmmn.constants.RequestMappingConstants"%>
	...
	$(document).ready(function() {
		...
		$("#contents tbody tr td").click(function(e) {
            if($(this).children('input').val() == '' || $(this).children('input').val() == undefined)
               ...
               // 초기화
               l_auth_no = $(this).children('input').val();
	...
	function fn_link_list(pageNo) {
		...
		changeContents("<%=RequestMappingConstants.WEB_MNG_LAYER_AUTH%>",pageData);
	}
	                ...
	                <div class="card-box big-card-box last table-responsive searchResult">
	                    ...
	                    <div class="table-wrap m-t-30">
	                        <table class="table table-custom table-cen table-num text-center table-hover" id='contents' >
	                        	<caption class="none">레이어 권한 목록 테이블</caption>
	                            <colgroup>
	                                <col style="width:5%">
		                   			<col style="width:25%">
		     			            <col style="width:10%">
										...
										<c:when test="${!empty layerInfoList}">
											<c:forEach items="${layerInfoList}" var="result" varStatus="status">
												<tr onclick="javascript:fn_link_detail('${result.l_auth_no}'); return false;" data-toggle="modal"  data-target="#layerDetail">
			                                        ...
			                                        <td title='레이어 목록을 확인 할 수 있습니다.'> 
			                                        	<input type='hidden' value='${result.l_auth_no}'>
        ...
        <div class="col-sm-12">
            <div class="card-box big-card-box last table-responsive searchResult">
                ...
                <div class="table-wrap m-t-30">
                    ...
                    <caption class="none">레이어 권한 상세 테이블</caption>
                        <colgroup>
                            <col style="width:20%">
                   			<col style="width:30%">
                   			<col style="width:20%">
	...
	<!-- Add Page-Body -->
    <div class="row" id="layerAdd" style='position: absolute; display: none; z-index:100;top: 288.5px;left: 578px;' role="dialog">
        <div class="col-sm-12">
            <div class="card-box big-card-box last table-responsive searchResult">
                <h5 class="header-title"><b>권한 신규 등록</b></h5>
                <div class="table-wrap m-t-30">
                    <table class="table table-custom table-cen table-num text-center table-hover" >
                    	<caption class="none">레이어 권한 신규 등록 테이블</caption>
                        <colgroup>
                        	<col style="width:20%">
                   			<col style="width:30%">
                   			<%-- <col style="width:20%">
        ...
        <div class="col-sm-12">
            <div class="card-box big-card-box last table-responsive searchResult">
                ...
                <div class="table-wrap m-t-30" style='overflow-y:auto; height:400px;'>
                    <table class="table table-custom table-cen table-num text-center table-hover" id='layerAuthRow' >
                    	<caption class="none">레이어 권한 목록 수정 테이블</caption>
                        <colgroup>
                        	<col style="width:5%">
                   			<col style="width:30%">
     			            <col style="width:20%">
                     ...
                     <thead>
                      <tr>
                          ...
                          <th>그룹명</th>
                          <th>레이어명</th>
                          <th>보기 <input name="toggle_view" id="toggle_view" type="checkbox"  title="보기 선택"></th>
                          <th>수정 <input name="toggle_edit" id="toggle_edit" type="checkbox" title="수정 선택"></th>
                          <th>다운로드 <input name="toggle_down" id="toggle_down" type="checkbox" title="다운로드 선택"></th>
                      </tr>
                     </thead>
                     <tbody>
                     </tbody>
