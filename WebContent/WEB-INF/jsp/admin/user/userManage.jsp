...
<%@ page import="egovframework.syesd.cmmn.constants.RequestMappingConstants"%>
	...
	function fn_link_list(pageNo) {
		...
		changeContents("<%=RequestMappingConstants.WEB_MNG_USER%>",pageData);
	}
	...
	<div class="contWrap">
        ...
        <div class="whiteCont">
            ...
            <!-- List Page-Body -->
	        <div class="row hei_100" id='userList' style='display: block;'>
	                ...
	                <div class="card-box big-card-box last table-responsive searchResult hei_100">
	                    ...
	                    <div class="table-wrap">
	                        <table class="table table-custom table-cen table-num text-center table-hover" id='contents' >
	                        	<caption class="none">사용자 목록 테이블</caption>
	                            <colgroup>
	                            	<col style="width:5%">
                        			<col style="width:15%">
                        			<col style="width:15%">
            ...
            <div class="card-box big-card-box last table-responsive searchResult">
                ...
                <div class="table-wrap m-t-30">
                    <table class="table table-custom table-cen table-num text-center table-hover" >
                    	<caption class="none">사용자 상세 목록 테이블</caption>
                        <colgroup>
                            <col style="width:20%">
                        	<col style="width:30%">
                        	<col style="width:20%">
