...
<script src="<c:url value='/resources/js/admin/statistics/userSumStat.js'/>"></script>
...
<script>
    ...
    var UserSumStatPage = {
       ...
       /*  initControls: function() {
        	//부서 select
             ...
             $('[data-ax5select="selectGroupId1"]').hide();
        }, */
        datepick: function(datepick) {
            ...
            function handleTransaction() {
                ...
                gfn_transaction("/mngSumStatUserData.do", "POST", param, dateVal);
            }
            
        },
        selectTrigger: function(obj) {
        	UserSumStatPage.datepick(dateVal);
        },
        buttonClick: function(_this) {
            ...
            if (buttonId === "excel1") {
                firstGrid.exportExcel("누계 - 접속자( "+excelNm+" ).xls");
            } else {
    ...
    function fn_callback(actionType, data) {
        ...
        secondGrid.setData(deptPercent);
       ...
       // var dept_nm = _select.val($('[data-ax5select="selectGroupId1"]'))[0].dept_nm;
        ...
        var timePeriod, labels_arr = []; 
            ...
            var labels = data.map(item => item.DEPT_NM);
        ...
        <div class="whiteCont">
            ...
            <div id="tab0">
					...
					<div class="clearfix" id="statusOpt">
						<div>
							<div class="form-inline" style="display: flex; align-items: center;">
							    <span class="small" style="flex-grow: 1;">※  마우스 <b class="text-orange">휠 확대/축소 및 이동 기능</b>을 통해 세부 정보를 확인하실 수 있습니다.</span>
								...
								<div id="BtnExcel" style="display: contents;">
									<button class="btn stat_btn btn-md" onclick="UserSumStatPage.buttonClick(this);" id="excel1">통계표 다운로드</button>
								</div>
							</div>
						</div>
					</div> 
				...
				<div class="container_chart">
					<div class="convertDiv1" style="height: 715px;">
						<label>통계 차트</label>
						<div class="chart-container_ht" >
							<canvas id="barChart"></canvas>
						</div>
					</div> 
					<div class="convertDiv2" style="height: 715px;">
						<label>접속자 접속률</label>
						<div class="board_table_wrap" style="height: 75vh;">
