...
<script src="<c:url value='/resources/js/admin/statistics/menuSumStat.js'/>"></script>
    ...
    var MenuSumStatPage = {
        ...
        selectTrigger: function(obj) {
            if (obj.item.name === 'selectGroupId1') {
            	MenuSumStatPage.getGridDataAjax();
            }
        },
        buttonClick: function(_this) {
        	if ($(_this).attr("id") === "excel1") {
                firstGrid.exportExcel("누계 - 메뉴별 조회.xls");
            } else {
        ...
        getGridDataAjax: function() {
            ...
            function handleTransaction() {
                ...
                gfn_transaction("/mngSumStatMenuData.do", "POST", param, "select");
            }
    ...
    function fn_callback(actionType, data){
    	...
    	switch (actionType) {
    	  ...
    	  case "select":
    		...
    		// 부서 퍼센트 데이터 설정
            var SumMenuDeptPercent = data.SumMenuDeptPercent;
            secondGrid.setData(SumMenuDeptPercent);
						...
						<div>
							<div class="form-inline" style="display: flex; align-items: center;">
								...
								<div id="BtnExcel" style="display: contents;">
									<button class="btn stat_btn btn-md" onclick="MenuSumStatPage.buttonClick(this);" id="excel1">통계표 다운로드</button>
								</div>
							</div>
						</div>
					</div>
