...
<head>
    ...
    <!-- jQuery Library -->
    <script type="text/javascript" src="<c:url value='/resources/js/util/editor/ap-image-zoom.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/resources/js/util/editor/ap-image-fullscreen.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/resources/js/util/jquery/jquery-gallery.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/resources/js/util/editor/screenfull.min.js'/>"></script>
	...
	$(document).ready(function() {
		...
		$("input[name=manageType]").change( function() {
			...
			if(manage == 'LAYER') $('#layerEdit').show();  //레이어
			if(manage == 'GROUP') $('#layerGroupEdit').show();  //레이어 그룹
			if(manage == 'MAPNG') $('#mapngEdit').show();  //그릅-레이어
			if(manage == 'SERVER') $('#serverEdit').show();  //지도서버
		});
