...
function infodetailshow(pnu,sn){
	...
	DetailWindow = window.open("${contextPath}/Content_SH_View_Detail.do?pnu="+pnu+'&sn='+sn+"&sh_kind="+div_nm+"&"+item_space
			,"searchDetail"
...
function infodetailshow_sh(gid, dist_ck){	
	...
	DetailWindow = window.open("${contextPath}/Content_SH_View_Detail_sh.do?gid="+gid+"&sh_kind="+div_nm+"&kind="+dist_ck
			,"searchDetail"
			,"toolbar=no, width=1100, height=750,directories=no,status=no,scrollorbars=yes,resizable=yes");
}
