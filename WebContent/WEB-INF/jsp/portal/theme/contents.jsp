...
<%-- <script type="text/javascript" src="<c:url value='/resources/js/util/jquery/jquery.min.js'/>"></script> --%>

<link rel="stylesheet" href="<c:url value='/resources/css/util/jquery/jquery.minicolors.css'/>" />
<link rel="stylesheet" href="<c:url value='/resources/css/util/editor/messagebox.css'/>" />
<link rel="stylesheet" href="<c:url value='/resources/css/util/bootstrap/bootstrap-treeview.min.css'/>" />

<script type="text/javascript" src="<c:url value='/resources/js/util/jquery/jquery.minicolors.js'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/util/editor/messagebox.js'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/util/bootstrap/bootstrap-treeview.min.js'/>"></script> 
...
<div id='theme' class="wrapper-content asset" style='z-index: 2020; background-color: #ffffff; display: none; left:80px;'>
...
<div id='themeDetail' class="wrapper-content asset" style='z-index: 2021; background-color: #ffffff; display: none; overflow-y: auto; left:80px;'>
	<div class="dashboard-box">
		<div class="container">
			<!-- Page-Title -->
			<div class="row">
