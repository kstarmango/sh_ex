		...
		$(document).ready(function(){
			...
			$('#userRegisterForm').validate({
				...
				messages:{
					...
					user_pass: {
						...
						identicalConsecutively:"동일한 숫자 및 문자를 연속해서 4번이상 사용하실 수 없습니다.",
						rangelength: "비밀번호는 10~15자 이내입니다."
					},
					re_user_pass: {
			...
			$('#btnRegSave').click(function(){
				if($("#userRegisterForm").valid())
				{
					...
					var data_form = $('#userRegisterForm').serialize();
					$.ajax({
						type : "POST",
						async : false,
						url : url,
                                    ...
                                    <form class="clearfix" id="userRegisterForm" name="userRegisterForm" onSubmit="return false;">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="input-group col-md-10 p-l-r-10">
                                                <input class="form-control required" name="user_id" id="user_id" type="text" maxlength="20" title="사용자ID" placeholder="사용자ID를 입력해주세요." />
                                            </div>
                                        </div>
