...
<head>
	...
	<!-- Map Export is PNG  -->
	<script src="/jsp/SH/js/mapExport/html2canvas.js"></script>
	<script src="/jsp/SH/js/mapExport/FileSaver.js"></script>
	<script src="/jsp/SH/js/mapExport/canvas-toBlob.js"></script>
...
<!-- <body> -->
	...
	<%-- <c:import url="/jsp/SH_/landmanager/Content_Header.jsp"></c:import>  2024/05/13 LEK 필요X--%>
