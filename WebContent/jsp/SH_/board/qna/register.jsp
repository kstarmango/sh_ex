	        ...
	        <div class="row">
	            <div class="col-sm-12">
	                <div class="card-box big-card-box last table-responsive searchResult">
	                    ...
	                    <c:choose>
							<c:when test="${qnaList[0].seq eq '' || qnaList[0].seq eq null}">
			                    <input type="hidden" name="re_lev" id="re_lev" value="1"/>
							</c:when>
							<c:otherwise>
			                    <input type="hidden" name="re_lev" id="re_lev" value="${qnaList[0].re_lev}"/>
			                    <input type="hidden" name="re_group" id="re_group" value="${qnaList[0].re_group}"/>
							</c:otherwise>
						</c:choose>
	                    ...
	                    <div class="table-wrap col-sm-10 col-sm-offset-1 m-t-30">
	                        ...
	                        <table class="table table-custom">
	                            ...
	                            <tr>
	                                ...
	                                <td colspan="3">
	                                    <input type="text" class="form-control input-sm"  name="board_sjt" id="board_sjt" placeholder="제목을 입력해주세요.">
	                                </td>
	                            </tr>
	                            <tr>
	                                <th scope="row">
	                                ...
	                                <td>
	                                    ...
	                                    <input type="text" class="form-control input-sm" name="user_id" readonly="" value="${userid}"/>
	                                </td>
	                                <th>
	                                ...
	                                <td>
	                                    <div class="input-group date datetimepickerEnd m-b-5">
											<input type="text" class="form-control input-group-addon m-b-0" name="regist_date" id="regist_date" title ="작성일자"  placeholder="작성일자를 선택하세요" />
	                            ...
	                            <tr>
	                                ...
	                                <td colspan="3">
	                                    <textarea class="form-control" rows="20" id="board_contents" name="board_contents"></textarea>
	                                </td>
	                            </tr>
	                    ...
	                    <div class="modal-footer">
	                        ...
	                        <c:choose>
								<c:when test="${qnaList[0].seq eq '' || qnaList[0].seq eq null}">
				                    <button type="button" class="btn btn-custom btn-md" onclick="add_qna()">
	                            		<span><i class="fa fa-check-circle m-r-5"></i>등록</span>
	                        		</button>
								</c:when>
								<c:otherwise>
				                    <button type="button" class="btn btn-custom btn-md" onclick="add_reqna()">
	                            		<span><i class="fa fa-check-circle m-r-5"></i>등록</span>
	                        		</button>
								</c:otherwise>
							</c:choose>
